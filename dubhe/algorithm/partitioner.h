...
namespace dubhe {
    ...
    */
    ...
    to schedule parallel iterations (e.g., dubhe::Taskflow::for_each).

    An partitioner defines the scheduling method for running parallel algorithms,
    such dubhe::Taskflow::for_each, dubhe::Taskflow::reduce, and so on.
    By default, we provide the following partitioners:

    + dubhe::GuidedPartitioner  to enable guided scheduling algorithm of adaptive chunk size
    + dubhe::DynamicPartitioner to enable dynamic scheduling algorithm of equal chunk size
    + dubhe::StaticPartitioner  to enable static scheduling algorithm of static chunk size
    + dubhe::RandomPartitioner  to enable random scheduling algorithm of random chunk size
    ...
    iteration, dubhe::StaticPartitioner can deliver the best performance.
    On the other hand, if the work unit per iteration is irregular and unbalanced,
    dubhe::GuidedPartitioner or dubhe::DynamicPartitioner can outperform dubhe::StaticPartitioner.
    In most situations, dubhe::GuidedPartitioner can deliver decent performance and
    ...
    taskflow.for_each_index(0, 100, 1,
      ...
      dubhe::StaticPartitioner(0, [](auto&& closure){
    ...
    @note
    The default closure wrapper (dubhe::DefaultClosureWrapper) does nothing but invoke
    ...
    */
    ...
    @tparam C closure wrapper type (default dubhe::DefaultClosureWrapper)
    ...
    taskflow.for_each_index(0, 100, 1,
      ...
      dubhe::GuidedPartitioner(0, [](auto&& closure){
        // do something before invoking the partitioned task
        // ...
    ...
    */
    ...
    taskflow.for_each_index(0, 100, 1,
      ...
      dubhe::DynamicPartitioner(0, [](auto&& closure){
        // do something before invoking the partitioned task
        // ...
    ...
    */
    ...
    Similar to dubhe::DynamicPartitioner,
    ...
    taskflow.for_each_index(0, 100, 1,
      ...
      dubhe::RandomPartitioner(0, [](auto&& closure){
        // do something before invoking the partitioned task
        // ...
    ...
    */
    ...
    /**
    @brief default partitioner set to dubhe::GuidedPartitioner
    ...
    */
    ...
    A partitioner is a derived type from dubhe::PartitionerBase.
    */
    template <typename P>
