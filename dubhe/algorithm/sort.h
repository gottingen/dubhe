...
namespace dubhe::detail {
    ...
    void parallel_3wqsort(dubhe::Runtime& rt, RandItr first, RandItr last, C compare) {
      ...
      if(l - first > 1 && is_swapped_l) {
        //rt.emplace([&](dubhe::Runtime& rtl) mutable {
      ...
      if(last - r > 1 && is_swapped_r) {
        //rt.emplace([&](dubhe::Runtime& rtr) mutable {
    ...
    DUBHE_FORCE_INLINE auto make_sort_task(B b, E e, C cmp) {
    ...
    DUBHE_FORCE_INLINE auto make_sort_task(B beg, E end) {
