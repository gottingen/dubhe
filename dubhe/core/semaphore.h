...
namespace dubhe {
    ...
    A dubhe::Semaphore object starts with an initial count.
    ...
    dubhe::Semaphore semaphore(1); // create a semaphore with initial count 1
    ...
    */
    class Semaphore {
      ...
      public:
        ...
        @code{.cpp}
        dubhe::Semaphore semaphore(4);  // concurrency constraint of 4 workers
        @endcode
        */
