...
namespace dubhe {
    ...
    */
    ...
    or std::function<int(dubhe::Runtime&)>.
    */
    template <typename C>
    ...
    std::function<dubhe::SmallVector<int>()> or
    std::function<dubhe::SmallVector<int>(dubhe::Runtime&)>.
    */
    template <typename C>
    ...
    or std::function<void(dubhe::Runtime&)>.
    */
    template <typename C>
    ...
    class Task {
      ...
      public:
        ...
        */
        ...
        dubhe::TaskPriority::HIGH (numerically equivalent to 0),
        dubhe::TaskPriority::NORMAL (numerically equivalent to 1), and
        dubhe::TaskPriority::LOW (numerically equivalent to 2).
    ...
    */
    ...
    @brief hash specialization for std::hash<dubhe::Task>
    */
    template <>
    struct hash<dubhe::Task> {
      auto operator() (const dubhe::Task& task) const noexcept {
    ...
    @brief hash specialization for std::hash<dubhe::TaskView>
    */
    template <>
    struct hash<dubhe::TaskView> {
      auto operator() (const dubhe::TaskView& task_view) const noexcept {
