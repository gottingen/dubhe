...
namespace dubhe {
    ...
    */
    ...
    The dubhe::ObserverInterface class allows users to define custom methods to monitor
    ...
    dubhe::ObserverInterface provides immutable wrappers,
    dubhe::WorkerView and dubhe::TaskView, over workers and tasks.

    Please refer to dubhe::WorkerView and dubhe::TaskView for details.
    ...
    struct MyObserver : public dubhe::ObserverInterface {
      ...
      void on_entry(WorkerView w, dubhe::TaskView tv) override final {
        std::ostringstream oss;
        oss << "worker " << w.id() << " ready to run " << tv.name() << '\n';
        std::cout << oss.str();
      }

      void on_exit(WorkerView w, dubhe::TaskView tv) override final {
        std::ostringstream oss;
    ...
    */
    ...
    A dubhe::ChromeObserver inherits dubhe::ObserverInterface and defines methods to dump
    ...
    // create a custom observer
    std::shared_ptr<dubhe::ChromeObserver> observer = executor.make_observer<dubhe::ChromeObserver>();
    ...
    */
    ...
    A dubhe::TFProfObserver inherits dubhe::ObserverInterface and defines methods to dump
    the observed thread activities into a format that can be visualized through
    @TFProf.
    ...
    // create a custom observer
    std::shared_ptr<dubhe::TFProfObserver> observer = executor.make_observer<dubhe::TFProfObserver>();
    ...
    */
    ...
    inline TFProfManager::TFProfManager() :
      _fpath {get_env(DUBHE_ENABLE_PROFILER)} {
