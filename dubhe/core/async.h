...
>
dubhe::AsyncTask Executor::silent_dependent_async(F&& func, Tasks&&... tasks) {
...
>
dubhe::AsyncTask Executor::silent_dependent_async(
...
>
dubhe::AsyncTask Executor::silent_dependent_async(F&& func, I first, I last) {
...
inline void Executor::_process_async_dependent(
  Node* node, dubhe::AsyncTask& task, size_t& num_dependents
) {
