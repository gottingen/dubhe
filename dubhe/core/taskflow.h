...
#include <dubhe/core/flow_builder.h>
...
namespace dubhe {
    ...
    dependency between two tasks. A task is one of the following types:
      ...
      2. subflow task        : the callable constructible from
                               @c std::function<void(dubhe::Subflow&)>
      3. condition task      : the callable constructible from
                               @c std::function<int()>
      4. multi-condition task: the callable constructible from
                               @c %std::function<dubhe::SmallVector<int>()>
      5. module task         : the task constructed from dubhe::Taskflow::composed_of
                               @c std::function<void(dubhe::Runtime&)>
    ...
    dubhe::Task A = taskflow.emplace([](){ std::cout << "TaskA\n"; });
    dubhe::Task B = taskflow.emplace([](){ std::cout << "TaskB\n"; });
    dubhe::Task C = taskflow.emplace([](){ std::cout << "TaskC\n"; });
    dubhe::Task D = taskflow.emplace([](){ std::cout << "TaskD\n"; });
    ...
    */
    class Taskflow : public FlowBuilder {
      ...
      public:
        ...
        @code{.cpp}
        dubhe::Taskflow taskflow("My Taskflow");
        ...
        */
        ...
        @code{.cpp}
        dubhe::Taskflow taskflow1(std::move(taskflow2));
        ...
        */
        ...
        @code{.cpp}
        dubhe::Task parent = taskflow.emplace([](dubhe::Subflow sf){
        ...
        */
        ...
        This method is similar to dubhe::Taskflow::dump(std::ostream& ostream),
        ...
        */
        ...
        dubhe::Taskflow::num_tasks is zero.
        */
        bool empty() const;
        ...
        */
        ...
        A visitor is a callable that takes an argument of type dubhe::Task
        and returns nothing. The following example iterates each task in a
        taskflow and prints its name:

        @code{.cpp}
        taskflow.for_each_task([](dubhe::Task task){
          std::cout << task.name() << '\n';
        });
        @endcode
        */
        ...
        */
        ...
        A graph object (of type dubhe::Graph) is the ultimate storage for the
    ...
    dubhe::Future is a derived class from std::future that will eventually hold the
    execution result of a submitted taskflow (dubhe::Executor::run)
    In addition to the base methods inherited from std::future,
    you can call dubhe::Future::cancel to cancel the execution of the running taskflow
    ...
    class Future : public std::future<T>  {
      ...
      public:
        ...
        */
        ...
        (non-preemptive).
        You can call dubhe::Future::wait to wait for the cancellation to complete.
        */
        bool cancel();
