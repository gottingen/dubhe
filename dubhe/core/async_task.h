...
namespace dubhe {
    ...
    A dubhe::AsyncTask is a lightweight handle that retains @em shared ownership
    ...
    dubhe::AsyncTask A = executor.silent_dependent_async([](){});
    ...
    dubhe::AsyncTask B = executor.silent_dependent_async([](){}, A);
    @endcode

    Currently, dubhe::AsyncTask is implemented based on the logic of
