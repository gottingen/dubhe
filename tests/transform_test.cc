...
TEST_CASE("ParallelTransform.Guided.1thread") {
  parallel_transform<std::vector<int>, dubhe::GuidedPartitioner<>>(1);
  parallel_transform<std::list<int>, dubhe::GuidedPartitioner<>>(1);
}

TEST_CASE("ParallelTransform.Guided.2threads") {
  parallel_transform<std::vector<int>, dubhe::GuidedPartitioner<>>(2);
  parallel_transform<std::list<int>, dubhe::GuidedPartitioner<>>(2);
}

TEST_CASE("ParallelTransform.Guided.3threads") {
  parallel_transform<std::vector<int>, dubhe::GuidedPartitioner<>>(3);
  parallel_transform<std::list<int>, dubhe::GuidedPartitioner<>>(3);
}

TEST_CASE("ParallelTransform.Guided.4threads") {
  parallel_transform<std::vector<int>, dubhe::GuidedPartitioner<>>(4);
  parallel_transform<std::list<int>, dubhe::GuidedPartitioner<>>(4);
}

// random
TEST_CASE("ParallelTransform.Random.1thread") {
  parallel_transform<std::vector<int>, dubhe::RandomPartitioner<>>(1);
  parallel_transform<std::list<int>, dubhe::RandomPartitioner<>>(1);
}

TEST_CASE("ParallelTransform.Random.2threads") {
  parallel_transform<std::vector<int>, dubhe::RandomPartitioner<>>(2);
  parallel_transform<std::list<int>, dubhe::RandomPartitioner<>>(2);
}

TEST_CASE("ParallelTransform.Random.3threads") {
  parallel_transform<std::vector<int>, dubhe::RandomPartitioner<>>(3);
  parallel_transform<std::list<int>, dubhe::RandomPartitioner<>>(3);
}

TEST_CASE("ParallelTransform.Random.4threads") {
  parallel_transform<std::vector<int>, dubhe::RandomPartitioner<>>(4);
  parallel_transform<std::list<int>, dubhe::RandomPartitioner<>>(4);
}

// static
TEST_CASE("ParallelTransform.Static.1thread") {
  parallel_transform<std::vector<int>, dubhe::StaticPartitioner<>>(1);
  parallel_transform<std::list<int>, dubhe::StaticPartitioner<>>(1);
}

TEST_CASE("ParallelTransform.Static.2threads") {
  parallel_transform<std::vector<int>, dubhe::StaticPartitioner<>>(2);
  parallel_transform<std::list<int>, dubhe::StaticPartitioner<>>(2);
}

TEST_CASE("ParallelTransform.Static.3threads") {
  parallel_transform<std::vector<int>, dubhe::StaticPartitioner<>>(3);
  parallel_transform<std::list<int>, dubhe::StaticPartitioner<>>(3);
}

TEST_CASE("ParallelTransform.Static.4threads") {
  parallel_transform<std::vector<int>, dubhe::StaticPartitioner<>>(4);
  parallel_transform<std::list<int>, dubhe::StaticPartitioner<>>(4);
}
...
TEST_CASE("ParallelTransform2.Guided.1thread") {
  parallel_transform2<std::vector<int>, dubhe::GuidedPartitioner<>>(1);
  parallel_transform2<std::list<int>, dubhe::GuidedPartitioner<>>(1);
}

TEST_CASE("ParallelTransform2.Guided.2threads") {
  parallel_transform2<std::vector<int>, dubhe::GuidedPartitioner<>>(2);
  parallel_transform2<std::list<int>, dubhe::GuidedPartitioner<>>(2);
}

TEST_CASE("ParallelTransform2.Guided.3threads") {
  parallel_transform2<std::vector<int>, dubhe::GuidedPartitioner<>>(3);
  parallel_transform2<std::list<int>, dubhe::GuidedPartitioner<>>(3);
}

TEST_CASE("ParallelTransform2.Guided.4threads") {
  parallel_transform2<std::vector<int>, dubhe::GuidedPartitioner<>>(4);
  parallel_transform2<std::list<int>, dubhe::GuidedPartitioner<>>(4);
}

// dynamic
TEST_CASE("ParallelTransform2.Dynamic.1thread") {
  parallel_transform2<std::vector<int>, dubhe::DynamicPartitioner<>>(1);
  parallel_transform2<std::list<int>, dubhe::DynamicPartitioner<>>(1);
}

TEST_CASE("ParallelTransform2.Dynamic.2threads") {
  parallel_transform2<std::vector<int>, dubhe::DynamicPartitioner<>>(2);
  parallel_transform2<std::list<int>, dubhe::DynamicPartitioner<>>(2);
}

TEST_CASE("ParallelTransform2.Dynamic.3threads") {
  parallel_transform2<std::vector<int>, dubhe::DynamicPartitioner<>>(3);
  parallel_transform2<std::list<int>, dubhe::DynamicPartitioner<>>(3);
}

TEST_CASE("ParallelTransform2.Dynamic.4threads") {
  parallel_transform2<std::vector<int>, dubhe::DynamicPartitioner<>>(4);
  parallel_transform2<std::list<int>, dubhe::DynamicPartitioner<>>(4);
}

// static
TEST_CASE("ParallelTransform2.Static.1thread") {
  parallel_transform2<std::vector<int>, dubhe::StaticPartitioner<>>(1);
  parallel_transform2<std::list<int>, dubhe::StaticPartitioner<>>(1);
}

TEST_CASE("ParallelTransform2.Static.2threads") {
  parallel_transform2<std::vector<int>, dubhe::StaticPartitioner<>>(2);
  parallel_transform2<std::list<int>, dubhe::StaticPartitioner<>>(2);
}

TEST_CASE("ParallelTransform2.Static.3threads") {
  parallel_transform2<std::vector<int>, dubhe::StaticPartitioner<>>(3);
  parallel_transform2<std::list<int>, dubhe::StaticPartitioner<>>(3);
}

TEST_CASE("ParallelTransform2.Static.4threads") {
  parallel_transform2<std::vector<int>, dubhe::StaticPartitioner<>>(4);
  parallel_transform2<std::list<int>, dubhe::StaticPartitioner<>>(4);
}

// random
TEST_CASE("ParallelTransform2.Random.1thread") {
  parallel_transform2<std::vector<int>, dubhe::RandomPartitioner<>>(1);
  parallel_transform2<std::list<int>, dubhe::RandomPartitioner<>>(1);
}

TEST_CASE("ParallelTransform2.Random.2threads") {
  parallel_transform2<std::vector<int>, dubhe::RandomPartitioner<>>(2);
  parallel_transform2<std::list<int>, dubhe::RandomPartitioner<>>(2);
}

TEST_CASE("ParallelTransform2.Random.3threads") {
  parallel_transform2<std::vector<int>, dubhe::RandomPartitioner<>>(3);
  parallel_transform2<std::list<int>, dubhe::RandomPartitioner<>>(3);
}

TEST_CASE("ParallelTransform2.Random.4threads") {
  parallel_transform2<std::vector<int>, dubhe::RandomPartitioner<>>(4);
  parallel_transform2<std::list<int>, dubhe::RandomPartitioner<>>(4);
}
...
void parallel_transform3(size_t W) {
  ...
  for(size_t N=0; N<1000; N=(N+1)*2) {
    ...
    auto to_tgt = taskflow.emplace([&](dubhe::Subflow& subflow) {
...
TEST_CASE("ParallelTransform3.Guided.1thread") {
  parallel_transform3<dubhe::GuidedPartitioner<>>(1);
  parallel_transform3<dubhe::GuidedPartitioner<>>(1);
}

TEST_CASE("ParallelTransform3.Guided.2threads") {
  parallel_transform3<dubhe::GuidedPartitioner<>>(2);
  parallel_transform3<dubhe::GuidedPartitioner<>>(2);
}

TEST_CASE("ParallelTransform3.Guided.3threads") {
  parallel_transform3<dubhe::GuidedPartitioner<>>(3);
  parallel_transform3<dubhe::GuidedPartitioner<>>(3);
}

TEST_CASE("ParallelTransform3.Guided.4threads") {
  parallel_transform3<dubhe::GuidedPartitioner<>>(4);
  parallel_transform3<dubhe::GuidedPartitioner<>>(4);
}

// dynamic
TEST_CASE("ParallelTransform3.Dynamic.1thread") {
  parallel_transform3<dubhe::DynamicPartitioner<>>(1);
  parallel_transform3<dubhe::DynamicPartitioner<>>(1);
}

TEST_CASE("ParallelTransform3.Dynamic.2threads") {
  parallel_transform3<dubhe::DynamicPartitioner<>>(2);
  parallel_transform3<dubhe::DynamicPartitioner<>>(2);
}

TEST_CASE("ParallelTransform3.Dynamic.3threads") {
  parallel_transform3<dubhe::DynamicPartitioner<>>(3);
  parallel_transform3<dubhe::DynamicPartitioner<>>(3);
}

TEST_CASE("ParallelTransform3.Dynamic.4threads") {
  parallel_transform3<dubhe::DynamicPartitioner<>>(4);
  parallel_transform3<dubhe::DynamicPartitioner<>>(4);
}

// static
TEST_CASE("ParallelTransform3.Static.1thread") {
  parallel_transform3<dubhe::StaticPartitioner<>>(1);
  parallel_transform3<dubhe::StaticPartitioner<>>(1);
}

TEST_CASE("ParallelTransform3.Static.2threads") {
  parallel_transform3<dubhe::StaticPartitioner<>>(2);
  parallel_transform3<dubhe::StaticPartitioner<>>(2);
}

TEST_CASE("ParallelTransform3.Static.3threads") {
  parallel_transform3<dubhe::StaticPartitioner<>>(3);
  parallel_transform3<dubhe::StaticPartitioner<>>(3);
}

TEST_CASE("ParallelTransform3.Static.4threads") {
  parallel_transform3<dubhe::StaticPartitioner<>>(4);
  parallel_transform3<dubhe::StaticPartitioner<>>(4);
}

// random
TEST_CASE("ParallelTransform3.Random.1thread") {
  parallel_transform3<dubhe::RandomPartitioner<>>(1);
  parallel_transform3<dubhe::RandomPartitioner<>>(1);
}

TEST_CASE("ParallelTransform3.Random.2threads") {
  parallel_transform3<dubhe::RandomPartitioner<>>(2);
  parallel_transform3<dubhe::RandomPartitioner<>>(2);
}

TEST_CASE("ParallelTransform3.Random.3threads") {
  parallel_transform3<dubhe::RandomPartitioner<>>(3);
  parallel_transform3<dubhe::RandomPartitioner<>>(3);
}

TEST_CASE("ParallelTransform3.Random.4threads") {
  parallel_transform3<dubhe::RandomPartitioner<>>(4);
  parallel_transform3<dubhe::RandomPartitioner<>>(4);
}
...
{
  // Write a test case for using the taskwrapper on dubhe::transform
